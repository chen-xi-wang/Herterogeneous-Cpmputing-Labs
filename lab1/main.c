...
#error "unknown OpenCL SDK environment"
    ...
    clSetKernelArg(kernel, 0, sizeof(cl_int), (void *)&wA);
    clSetKernelArg(kernel, 1, sizeof(cl_int), (void *)&hA);
    clSetKernelArg(kernel, 2, sizeof(cl_int), (void *)&wB);
    clSetKernelArg(kernel, 3, sizeof(cl_int), (void *)&hB);
    clSetKernelArg(kernel, 4, sizeof(cl_int), (void *)&wC);
    clSetKernelArg(kernel, 5, sizeof(cl_int), (void *)&hC);
    ...
    clSetKernelArg(kernel, 9, sizeof(cl_mem), (void *)&bufferD);
